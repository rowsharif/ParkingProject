                ...
                */}
                ...
                {news.DateTime && (
                  <View>
                    ...
                    >
                      Date : {news.DateTime.toDate().getDate()}-
                      {news.DateTime.toDate().getMonth() + 1}-
                      {news.DateTime.toDate().getFullYear()} -
                      <Text style={{ marginLeft: 150 }}>
                        {" "}
                        Time {news.DateTime.toDate().getHours()}:
                        {news.DateTime.toDate().getMinutes()}
                      </Text>
                    </Text>
                  </View>
                )}
                ...
                >
                  ...
                  {item.DateTime && (
                    <View>
                      ...
                      >
                        Date : {item.DateTime.toDate().getDate()}-
                        {item.DateTime.toDate().getMonth() + 1}-
                        {item.DateTime.toDate().getFullYear()} -
                        <Text style={{ marginLeft: 150 }}>
                          {" "}
                          Time {item.DateTime.toDate().getHours()}:
                  ...
                  >
                    ...
                    <Text style={{ width: "67%", height: 100, marginLeft: 8 }}>
                      {item.body}
                    </Text>
                  </View>
                </TouchableOpacity>
